...
| Measurement-null extension | `ACTIVE SENTINEL` | The preregistered design is frozen; sentinel is 30/120 and full-corpus qualification has not started. |
| Sentinel executor | `ACTIVE 30/120` | Checkpoints 1-30 are replay-verified; technical-only, non-qualifying, and full-corpus execution remains unavailable. |
