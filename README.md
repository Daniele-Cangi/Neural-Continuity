...
| Measurement-null extension | `ACTIVE SENTINEL` | The preregistered design is frozen; sentinel is 20/120 and full-corpus qualification has not started. |
| Sentinel executor | `ACTIVE 20/120` | Checkpoints 1-20 are replay-verified; technical-only, non-qualifying, and full-corpus execution remains unavailable. |
